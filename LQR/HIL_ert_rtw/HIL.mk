###########################################################################
## Makefile generated for component 'HIL'. 
## 
## Makefile     : HIL.mk
## Generated on : Wed Jan 01 20:26:22 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HIL.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HIL.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=160 -DXCP_MEM_BLOCK_3_NUMBER=1 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=1189 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DXCP_MIN_EVENT_NO_RESERVED_POOL=1 -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=65536 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=HIL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o ESP32Encoder.o DualEncoder.o xcp_ext_mode.o HIL.o HIL_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/HIL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/HIL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
ert_main.o : $(START_DIR)/HIL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


HIL.o : $(START_DIR)/HIL_ert_rtw/HIL.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


HIL_data.o : $(START_DIR)/HIL_ert_rtw/HIL_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetInf.o : $(START_DIR)/HIL_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rtGetNaN.o : $(START_DIR)/HIL_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


rt_nonfinite.o : $(START_DIR)/HIL_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
