...
#ifndef RTW_HEADER_HIL_types_h_
#define RTW_HEADER_HIL_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
#ifndef typedef_DualEncoder_HIL_T
#define typedef_DualEncoder_HIL_T

typedef struct tag_fLDw7eUr6pSrlwUMNLE5OG DualEncoder_HIL_T;

#endif                                 /* typedef_DualEncoder_HIL_T */

/* Parameters (default storage) */
typedef struct P_HIL_T_ P_HIL_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_HIL_T RT_MODEL_HIL_T;

#endif                                 /* RTW_HEADER_HIL_types_h_ */
