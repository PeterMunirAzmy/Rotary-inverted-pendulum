...
#ifndef RTW_HEADER_HILWithSwingUp_types_h_
#define RTW_HEADER_HILWithSwingUp_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
/* Custom Type definition for MATLABSystem: '<Root>/Enable pin' */
#include "MW_SVD.h"
...
#ifndef struct_tag_fLDw7eUr6pSrlwUMNLE5OG
#define struct_tag_fLDw7eUr6pSrlwUMNLE5OG

struct tag_fLDw7eUr6pSrlwUMNLE5OG
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                 /* struct_tag_fLDw7eUr6pSrlwUMNLE5OG */

#ifndef typedef_DualEncoder_HILWithSwingUp_T
#define typedef_DualEncoder_HILWithSwingUp_T

typedef struct tag_fLDw7eUr6pSrlwUMNLE5OG DualEncoder_HILWithSwingUp_T;

#endif                                /* typedef_DualEncoder_HILWithSwingUp_T */

/* Parameters (default storage) */
typedef struct P_HILWithSwingUp_T_ P_HILWithSwingUp_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_HILWithSwingUp_T RT_MODEL_HILWithSwingUp_T;

#endif                                 /* RTW_HEADER_HILWithSwingUp_types_h_ */
